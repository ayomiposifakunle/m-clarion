...
function popup(){
  ...
  return (
   ...
   <div className='text-black p-8'>
    <h1 className='text-2xl font-bold'>AN INTEGRATED APPROACH TO GRC POWERED BY AI</h1>
<h3 className='font-bold'>This Is Where Intelligence Meets Integrity in GRC for Business Success.</h3>
    <p className='my-2'>M-clarion is distributed by its capability to align risk with business objectives, which empowers your organization to reliably accomplish its objectives, navigate through uncertainties, and showcase integrity.
   ...
   <div className='flex  flex-row justify-center pb-10 text-grey'>
    ...
    <div style={{border: '1px solid #FF0099'}} class="max-w-sm p-6 m-5 border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
        ...
        <p class="mb-3 font-bold text-gray-700 dark:text-gray-400 uppercase">Alignment, Oversight, and Achievement of business goals</p>
        ...
        <Link to='/governance' style={{backgroundColor: '#FF0099'}} href="" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Read More</Link>
    </div>
    ...
    <div style={{border: '1px solid #FF0099'}}  class="max-w-sm p-6 m-5 border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
        ...
        <p class="mb-3 font-bold text-gray-700 dark:text-gray-400 uppercase">Identify, Track, and, Manage risks of different categories with confidence. </p>
        ...
        <Link to='/risk' style={{backgroundColor: '#FF0099'}} href="" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Read More</Link>
    </div>
    ...
    <div style={{border: '1px solid #FF0099'}} class="max-w-sm p-6 m-5 border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
        ...
        <p class="mb-3 font-bold text-gray-700 dark:text-gray-400 uppercase">Set up a  library of obligations and ensure compliance with laws and procedures.</p>
        ...
        <Link to='/compliance' style={{backgroundColor: '#FF0099'}} href="" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Read More</Link>
    </div>
