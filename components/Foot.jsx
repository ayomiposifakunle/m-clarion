    ...
    <div class="container p-6 mx-auto">
        <div class="lg:flex">
            <div class="w-full -mx-6 lg:w-2/5">
                <div class="px-6">
                    <a href="#">
                        <img class="w-auto h-7" src="/m-clarion-logo_big-removebg-preview.png" alt="" />
                    </a>

                    <p class="max-w-sm mt-2 text-gray-500 dark:text-gray-400">All-in-One AI Ally for GRC Success. You can Streamline compliance, mitigate risks, and boost efficiency -all from a unified platform</p>
            ...
            <div class="mt-6 lg:mt-0 lg:flex-1">
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                    <div>
                       ...
                       <Link to='/governance' class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Governance</Link>
                       <Link to='/risk' class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Risk</Link>
                       <Link to='/compliance' class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Compliance</Link>
                    </div>
                    ...
                    <div className='w-max'>
                        ...
                        <span class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">+234 916-2644-779</span>
